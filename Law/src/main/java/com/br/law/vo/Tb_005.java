...
public class Tb_005 {
	...
	public Tb_005(int aplcn_dtls_proper_num, int user_proper_num, int announce_proper_num, int court_proper_num,
			String ligtn_case_carer_yn, String ligtn_case_carer_etc, String insrn_indst_carer_yn,
			String insrn_indst_carer_etc, String criminal_penalty_carer_yn, String criminal_penalty_carer_etc,
			String aplcn_dtls_sts, Date aplcn_dtls_date) {
		super();
