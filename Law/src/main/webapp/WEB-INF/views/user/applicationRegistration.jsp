...
<jsp:include page="../common/header.jsp"></jsp:include>
	...
	<div class="col container-fluid" style="width : 1800px;">
	 <div class="row mt-4 mx-5">
        ...
        <div class="row">
        	<form action="../user/applicationRegistrationProcess">
	            <div class="row">신청인 기본정보</div>
	            <div class="row">
	                <div class="row">
	                    <div class="col">이름</div>
	                    <div class="col"><input type="text" name="user_name"></div>
	                </div>
	                <div class="row">
	                ...
	                <div class="row">
	                    <div class="row">
	                        ...
	                        <div class="col"><input type="text" name="user_ar"></div>
	                    </div>
	                    <div class="row">
	                        <div class="col">우편주소 : </div>
	                        <div class="col"><input type="text" name="user_ar_zonecode"></div>
	                    </div>
	                    <div class="row">
	                        <div class="col">지번주소 : </div>
	                        <div class="col"><input type="text" name="user_ar_jibun"></div>
	                    </div>
	                    <div class="row">
	                        <div class="col">상세주소 : </div>
	                        <div class="col"><input type="text" name="user_ar_detail"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                        <div class="col">나이 : </div>
	                        <div class="col"><input type="number" name="user_age"></div>
	                    </div>
	                    
	                    <div class="row">
	                    	<div class="col">예금주 : </div>
	                    	<div class="col"><input type="text" name="user_bank_holder"></div>
	                    </div>
	                    <div class="row">
	                    ...
	                    <div class="row">
	                    	...
	                    	<div class="col"><input type="text" name="user_bank_account"></div>
	                    </div>
	                    <div class="row">
	                    	<div class="col">아이디 : </div>
	                    	<div class="col"><input type="text" name="user_id"></div>
	                    </div>
	                    <div class="row">
	                    	<div class="col">비밀번호 : </div>
	                    	<div class="col"><input type="password" name="user_pw"></div>
	                    </div>
	                </div>
