...
<jsp:include page="../common/header.jsp"></jsp:include>
	...
	<div id="content">
		<div class="row">
			<div class="col"><a href="#"><b>감정인 등재공고</b></a></div>
			<div class="col-6"></div>
			<div class="col">
				<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="../user/main">홈</a></li>
						<li class="breadcrumb-item"><a href="./member/notice">공지사항</a></li>
		...
		<div class="row">
			<div class="col"><a href="../member/notice"><b>공지사항</b></a></div>
			<div class="col"></div>
		</div>
		
		<div class="row">
			<div class="col"><a href="../member/faqPage"><b>FAQ </b></a></div>
			<div class="col-6">
