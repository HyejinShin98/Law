        ...
        <div class="row">
        	<form action="../applicationRegistrationProcess">
	            <div class="row">재판조력자 선발 신청자 경력상세</div>
	                ...
	                <div class="row">
	                    <div class="row">
	                    	<div class="col">자격증 종목 : </div>
	                    	<div class="col"><input type="text" name="crtfc_type"></div>
	                    </div>
	                    <div class="row">
	                    	<div class="col">발급기관 : </div>
	                    	<div class="col"><input type="text" name="issue_agency"></div>
	                    </div>
	                    <div class="row">
	                    	<div class="col">자격증/면허 번호 : </div>
	                    	<div class="col"><input type="text" name="crtfc_number"></div>
	                    </div>
	                    <div class="row">
	                    	<div class="col">발급일 : </div>
	                    	<div class="col"><input type="date" name="issue_date"></div>
	                    </div>
	                </div>
