	 ...
	 <div class="row mt-4 mx-5">
        ...
        <div class="row">
        	<form action="../applicationRegistrationProcess">
	            <div class="row">재판조력자 선발 신청자 학력상세</div>
	            	<div class="row">
	                    <div class="row">
	                    	<div class="col">학교명 : </div>
	                    	<div class="col"><input type="text" name="school_name"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                    	<div class="col">학과 전공 : </div>
	                    	<div class="col"><input type="text" name="major"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                    	<div class="col">학위 : </div>
	                    	<div class="col"><input type="text" name="degree"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                    	<div class="col">입학일 : </div>
	                    	<div class="col"><input type="date" name="admsn_date"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                    	<div class="col">졸업일 : </div>
	                    	<div class="col"><input type="date" name="grdtn_date"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                    	<div class="col">최종학력 여부 </div>
	                    	<div class="col"><input type="radio" name="final_edctn_yn"></div>
	                    </div>
	                </div>
