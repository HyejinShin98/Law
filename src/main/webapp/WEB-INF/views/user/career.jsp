        ...
        <div class="row">
        	<form action="../applicationRegistrationProcess">
	            <div class="row">재판조력자 선발 신청자 경력상세</div>
	            	<div class="row">
	                    <div class="row">
	                    	<div class="col">회사명/활동기관 명 : </div>
	                    	<div class="col"><input type="text" name="company_name"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                    	<div class="col">경력 구분 : </div>
	                    	<div class="col"><input type="text" name="carer_type"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                    	<div class="col">근무 시작 일자 : </div>
	                    	<div class="col"><input type="date" name="work_start_date"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                    	<div class="col">근무 종료 일자 : </div>
	                    	<div class="col"><input type="date" name="work_end_date"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                    	<div class="col">수행 업무 : </div>
	                    	<div class="col"><input type="text" name="work_department"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                ...
	                <div class="row">
	                    <div class="row">
	                    	...
	                    	<div class="col"><input type="text" name="work_position"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                    	<div class="col">활동 경력 설명 : </div>
	                    	<div class="col"><input type="text" name="carer_description"></div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="row">
	                    	<div class="col">특기사항 : </div>
	                    	<div class="col"><input type="text" name="special_note_description"></div>
	                    </div>
	                </div>
